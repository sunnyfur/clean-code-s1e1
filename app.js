...
var completedTasksHolder=document.querySelector(".tasks_done");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='task__text task__text_notedit';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList="task__checkbox";
    editInput.type="text";
    editInput.className="task__text task__input task__text_edit";
